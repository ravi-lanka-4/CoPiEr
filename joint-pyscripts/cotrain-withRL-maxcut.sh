...
SPATIAL_POLICY_HOME=$COTRAIN_HOME/spatial-policy/graph_comb_opt/code/s2v_maxcut/
...
learn_spatial(){
  ...
  python main.py -n_step $n_step -dev_id $dev_id \
                 ...
                 -eps_step $EPS_STEP -sup_prob $sup_prob \
                 -behavior_cloning $BC_FLAG -avg_global 0
  ...
  python evaluate.py -n_step $n_step -dev_id $dev_id -data_test $DATA_TEST \
                     ...
                     -modelF $modelF -l2 0.00 -w_scale $w_scale -avg_global 0
...
self_imit=1
decay=0
experiment="maxcut_cotrain_search"
