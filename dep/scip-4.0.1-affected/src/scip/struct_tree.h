...
struct SCIP_Node
{
   ...
   SCIP_Longint          solidx;             /**< Solution index of the current node */
   SCIP_Real             bestbound;          /**< Best bound is best lower bound that can be reached from current node */
   SCIP_Longint          nsolflag;           /**< number of sol flags */
   union
   {
   ...
   OPT_FLAG*             solflag;            /**< solution flag used for self-imitation */
