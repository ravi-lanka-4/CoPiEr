...
#define SCIP_DEFAULT_WRITE_GENNAMES_OFFSET    0 /**< when writing the problem with generic names, we start with index
                                                 ...
                                                 *   different */
/* TRACE Tool output */
#define SCIP_DEFAULT_TRACE_FILENAME         "-" /**< name of the TRACE Tool output file, or "-" if no output should be created */
   ...
   )
{
   ...
   (*set)->allsols_write = NULL;
   (*set)->allsols_prefix = NULL;
   (*set)->nlp_solver = NULL;
   ...
   SCIP_CALL( SCIPsetAddStringParam(*set, messagehdlr, blkmem,
         "allsols/write",
         "name of the TRACE Tool output file, or - if no TRACE Tool output should be created",
         &(*set)->allsols_write, FALSE, SCIP_DEFAULT_TRACE_FILENAME,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddStringParam(*set, messagehdlr, blkmem,
         "allsols/prefix",
         "name of the TRACE Tool output file, or - if no TRACE Tool output should be created",
         &(*set)->allsols_prefix, FALSE, SCIP_DEFAULT_TRACE_FILENAME,
         NULL, NULL) );
