...
#define SCIP_INVALID          (double)1e+50  /**< floating point value is not valid */
#define SCIP_UNKNOWN          (double)1e+50  /**< floating point value is not known (in primal solution) */
