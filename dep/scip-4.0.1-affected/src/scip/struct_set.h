...
struct SCIP_Set
{
   ...
   /* Trace tool settings */
   char*                 allsols_write;     /**< name of the Trace output from the optimal leaf node to the root */
   char*                 allsols_prefix;     /**< name of the Trace output from the optimal leaf node to the root */
