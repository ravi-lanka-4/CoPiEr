...
EXTERN
SCIP_Real SCIPnodeGetBranchBound(
  SCIP_NODE*            node                /**< node */
);

EXTERN
SCIP_Real SCIPnodeGetName(
  SCIP_NODE*            node                /**< node */
);
...
#define SCIPnodeGetBranchBound(node)    ((node)->branchbound)
#define SCIPnodeGetBoundType(node)      ((node)->boundtype)
#define SCIPnodeGetName(node)           ((node)->name)
#define SCIPnodeSetScore(node, score_)  ((node)->score = score_)
#define SCIPnodeGetSolIdx(node)         ((node)->solidx)
#define SCIPnodeSetSolIdx(node, idx)    ((node)->solidx = idx)
#define SCIPnodeGetIndex1(node)         ((node)->index1)
#define SCIPnodeGetIndex2(node)         ((node)->index2)
#define SCIPnodeGetIndex3(node)         ((node)->index3)
